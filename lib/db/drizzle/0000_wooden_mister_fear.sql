...
CREATE TABLE `homepage_content` (
	...
	`stats` text DEFAULT '[{"value":"10+","label":"Global Projects"},{"value":"50%","label":"Efficiency"},{"value":"100%","label":"Sustainable Focus"}]' NOT NULL,
